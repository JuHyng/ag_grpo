...
class DiffuGRPOConfig(TrainingArguments):
    ...
    answer_length: Optional[int] = field(
        default=None,
        metadata={"help": "Expected answer length."},
    )
    ...
    no_answer_padding: bool = field(
        default=False,
        metadata={"help": "Whether to not pad the answer."},
    )
    
    answer_additional_length: Optional[int] = field(
        default=0,
        metadata={"help": "Additional length to add to the answer length."},
    )
    
    answer_steps: Optional[int] = field(
        default=None,
