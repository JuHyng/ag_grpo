...
AG_BLOCK_LENGTH=256
BETA=0.04
NUM_AG_GENERATIONS=3

for DIFFUSION_STEPS in 64;
do
DIFFUSION_TYPE="ag_grpo" # choose from ['d1', 'ag_grpo']
...
RUN_NAME=${MODEL_NAME}/${DIFFUSION_TYPE}/${DATASET}/time:${TIME_STAMP}_iter:${NUM_ITER}_gen:${GEN_BATCH}_diff_steps:${DIFFUSION_STEPS}_block_len:${BLOCK_LENGTH}_ans_len:${ANSWER_LENGTH}_adv_type:${ADVANTAGE_TYPE}_ag_block_len:${AG_BLOCK_LENGTH}_no_ans_pad:${NO_ANSWER_PADDING}_add_ans_len:${ADDITIONAL_ANSWER_LENGTH}_ans_steps:${ANSWER_STEPS}_beta:${BETA}
